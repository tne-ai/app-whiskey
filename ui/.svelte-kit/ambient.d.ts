...
declare module '$env/static/private' {
	...
	export const USE_GRAPHAI: string;
	export const GRAPHAI_SERVER_MODE: string;
	export const GRAPHAI_ENDPOINT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		USE_GRAPHAI: string;
		GRAPHAI_SERVER_MODE: string;
		GRAPHAI_ENDPOINT: string;
		NODE: string;
		INIT_CWD: string;
		SHELL: string;
		TERM: string;
